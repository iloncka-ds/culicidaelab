...
# from culicidaelab.modules.segmenter import MosquitoSegmenter  # If exists
...
def run_batch_test(
    ...
    metrics = results.pop("result")  # Separate metrics from system measurements
...
if __name__ == "__main__":
    ...
    # seg_weights = weights_manager.get_weights("segmentation")
    ...
    # segmenter = MosquitoSegmenter(seg_weights, config_manager)
    ...
    # run_batch_test("segmentation", segmenter, inputs, seg_truths, Path("logs/segmentation"), config_manager)
