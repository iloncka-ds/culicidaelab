...
<!--
 ...
 "examples/tutorial_part_1_mosquito_detection.py"
...
```{.shell .mkd-glr-script-out-disp }
C:/Users/lenova/CascadeProjects/culicidaelab/examples/tutorial_part_1_mosquito_detection.py:69: UserWarning: FigureCanvasAgg is non-interactive, and thus cannot be shown
  plt.show()
...
Predicting detection batch:  33%|#############                          | 1/3 [00:00<00:01,  1.94it/s]Predicting detection batch: 100%|#######################################| 3/3 [00:00<00:00,  5.82it/s]
...
{'f1_mean': 0.9999999989999999, 'f1_std': 0.0, 'ap_mean': 0.9999999989999999, 'ap_std': 0.0, 'mean_iou_mean': 0.9999999403953552, 'mean_iou_std': 8.429369702178807e-08, 'recall_mean': 1.0, 'recall_std': 0.0, 'precision_mean': 0.9999999989999999, 'precision_std': 0.0, 'count': 3}
...
[![Launch binder](./images/binder_badge_logo.svg)](https://mybinder.org/v2/gh/iloncka-ds/culicidaelab/gh-pages?urlpath=lab/tree/examples/generated/gallery/tutorial_part_1_mosquito_detection.ipynb){ .center}
